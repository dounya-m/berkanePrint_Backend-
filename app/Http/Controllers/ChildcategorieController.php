...
class ChildcategorieController extends Controller
{
    ...
    {
        $child = new Childcategorie();

        $child->categorie = $request->input('categorie');
        $child->child_categorie = $request->input('child_categorie');
        $child->save();
    ...
    public function all()
    {
        ...
        $child = Childcategorie::select('*')->orderBy('child_categorie', 'asc')->get();
        return response()->json($child);
    }
    /**
